...
export const ROUND_53: QuizQuestion[] = [
  ...
  },
  {
    ...
    "subject": "1과목",
    "number": 3,
    "title": "아래 ERD 의 네 엔터티를 발생 시점에 따라 분류할 때 옳지 않은 것은?",
    "options": [
      "고객은 기본 엔터티이다.",
      "주문은 중심 엔터티이다.",
      "주문상세는 행위 엔터티이다.",
    ...
    "correctIndex": 3,
    "explanation": "기본 엔터티는 업무에 원래부터 존재해 다른 엔터티로부터 발생하지 않는 것으로 고객이 해당한다. 중심 엔터티는 기본 엔터티로부터 발생해 업무의 중심이 되는 것으로 주문이 해당하고, 행위 엔터티는 두 개 이상의 엔터티나 업무 행위로부터 발생하는 것으로 주문상세·배송추적이 해당한다. 배송추적은 주문이 있어야 생기므로 기본 엔터티가 아니다.",
    "_source": "authored",
    "references": [
      {
        "type": "erd",
        "caption": "고객·주문·주문상세·배송추적 ERD",
        "mermaid": "erDiagram\n    고객 ||--o{ 주문 : \"한다\"\n    주문 ||--o{ 주문상세 : \"포함\"\n    주문 ||--o{ 배송추적 : \"발생\""
      }
    ]
  },
  {
    ...
    "correctIndex": 2,
    "explanation": "주식별자에 일반 속성이 모두 함수 종속하면서 이행 함수 종속까지 제거된 상태는 3정규형이다.",
    "_source": "authored",
    "references": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation": "부분 함수 종속을 분리하여 해결하는 정규화 단계는 2정규화이다.",
    "_source": "authored",
    "references": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "외래키(FK)는 다른 엔터티(부모 테이블)의 주식별자를 참조하여 참조 무결성을 보장한다.",
    "_source": "authored"
  },
  {
    "id": 10358,
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation": "GRANT 와 REVOKE 는 권한을 부여·회수하는 데이터 제어어(DCL)이다. CREATE/ALTER 는 DDL, INSERT/UPDATE 는 DML, COMMIT/ROLLBACK 은 TCL 이다.",
    "_source": "authored"
  },
  {
    "id": 10361,
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "DENSE_RANK 는 동순위를 같은 등수로 부여하면서 다음 등수를 건너뛰지 않아, 상위 N 순위 동순위 포함 조회에 적합하다.",
    "_source": "authored"
  },
  {
    "id": 10369,
  ...
  },
  {
    ...
    "correctIndex": 3,
    "explanation": "MINUS 는 첫 번째 집합에서 두 번째 집합에 존재하는 행을 제외한 차집합을 반환한다.",
    "_source": "authored",
    "references": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "CROSS JOIN 의 결과 행 수는 두 테이블의 카디널리티 곱이므로 3 × 5 = 15 이다.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "NOCYCLE 옵션은 순환을 만나면 전개를 중단하며, 순환이 발생한 행은 CONNECT_BY_ISCYCLE 의사 컬럼으로 식별할 수 있다.",
    "_source": "authored"
  },
  {
    "id": 10391,
