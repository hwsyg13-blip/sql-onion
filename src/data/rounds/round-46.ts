...
export const ROUND_46: QuizQuestion[] = [
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation": "컴퓨터 쪽 선택 참여(o)·단일성(|)이므로 마더보드 입장에서 컴퓨터 참여는 선택적이고, 마더보드 쪽 필수 참여(|)·단일성(|)이므로 컴퓨터 하나당 마더보드 하나가 대응된다.",
    "_source": "authored"
  },
  {
    "id": 10680,
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation": "고객 쪽 참여가 선택적(점선) 관계이면 소속 지점이 없는 고객이 존재할 수 있어, 조인 시 OUTER JOIN 또는 별도 조회가 필요하다.",
    "_source": "authored"
  },
  {
    "id": 10699,
