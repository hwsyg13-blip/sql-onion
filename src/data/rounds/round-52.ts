...
export const ROUND_52: QuizQuestion[] = [
  ...
  },
  {
    ...
    "subject": "1과목",
    "number": 2,
    "title": "학생 테이블에서 학과가 삭제될 때의 적절한 처리 방식으로 옳은 것은?",
    "options": [
      "학과를 삭제한다.",
      "학생 전체를 삭제한다.",
      "학과 컬럼을 NULL 로 갱신한다.",
    ...
    "correctIndex": 0,
    "explanation": "원본 기출의 정답 표기를 보존한다. 참조 관계 설정에 따라 학과 엔터티 삭제가 정상 처리되는 경우를 묻는 문항으로 출제되었다.",
    "_source": "authored",
    "references": [
      {
        "type": "text",
        "content": "원본 PDF 표기: '문제 2. 학생데이터 문제 / 정답: 1번,학과를 삭제한다 vs 4번' — 원본에서도 본문·선지가 축약 메모 형태로만 남아 있고, 1번과 4번 사이에 정답 논쟁이 있었음을 알 수 있다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 22,
    "title": "세 번째 문자가 'L' 인 단어를 찾는 LIKE 패턴으로 옳은 것은?",
    "options": [
      "'L%'",
      "'%L'",
      "'_ _ L%'",
    ...
    "correctIndex": 2,
    "explanation": "'_' 는 임의의 한 문자, '%' 는 0개 이상의 임의 문자를 의미한다.",
    "_source": "authored"
  },
  {
    "id": 10422,
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 25,
    "title": "아래 두 컬럼 A, B 의 값이 서로 다른 결과가 되는 SQL 은?",
    "options": [
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 26,
    "title": "제품·생산제품·생산라인 엔터티가 있을 때 제품과 생산라인을 직접 조인하면 발생하는 결과는?",
    "options": [
      "정상 조인 결과",
      "중복 제거된 결과",
      "공집합",
    ...
    "correctIndex": 3,
    "explanation": "두 엔터티 사이에 직접 연결 키가 없기 때문에 중간 엔터티 없이 직접 조인하면 카티션 곱이 발생한다.",
    "_source": "authored"
  },
  {
    "id": 10426,
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation": "원본 기출에서 구체적 데이터 값과 본문 SQL 은 유실되어 정답 번호(②)와 결과값(8,925)만 보존한다. MAX·MIN 두 집계 결과를 UNION 으로 합친 뒤 전체 합계를 구하는 형태로 출제되어, 두 값의 합이 8,925 가 되도록 데이터가 구성되었다.",
    "_source": "authored",
    "references": [
      {
        "type": "text",
        "content": "원본 PDF 표기: '문제 34. MAX MIN + union 중복제거 / 정답: 8925' — 본문 SQL·테이블 데이터·선지 텍스트는 원본 복원 메모에서 누락되었고, 패턴 키워드(MAX MIN + UNION 중복제거)와 정답값만 남아 있다."
      },
      {
        "type": "sql",
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 35,
    "title": "아래 ROLLUP 절 중 소계와 총계를 한 번에 나타내기 위해 괄호를 중첩한 구문으로 옳은 것은?",
    "options": [
      "ROLLUP(A, B)",
      "ROLLUP((A), B)",
      "ROLLUP((A, B))",
    ...
    "correctIndex": 2,
    "explanation": "중첩 괄호는 (A, B) 를 하나의 단위로 취급하여 () 총계만 추가로 반환한다.",
    "_source": "authored"
  },
  {
    "id": 10435,
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 40,
    "title": "WHERE NOT(COL <= 2) 조건에서 결과로 반환되는 COL 값은? (COL 에 NULL, 1, 2, 3, 4 가 있다고 가정)",
    "options": [
      "NULL, 3, 4",
      "1, 2",
      "3, 4",
    ...
    "correctIndex": 2,
    "explanation": "NOT (UNKNOWN) 은 UNKNOWN 이므로 NULL 행은 제외된다. COL > 2 를 만족하는 3, 4 만 반환된다.",
    "_source": "authored"
  },
  {
    "id": 10440,
    ...
    "subject": "2과목",
    "number": 41,
    "title": "아래 네 가지 JOIN SQL 중 결과 행 수가 나머지와 다른 것은?",
    "options": [
      "INNER JOIN",
      "LEFT OUTER JOIN",
      "RIGHT OUTER JOIN",
    ...
    "correctIndex": 3,
    "explanation": "CROSS JOIN 은 두 테이블의 모든 조합을 반환하므로 결과 행 수가 가장 많다.",
    "_source": "authored"
  },
  {
    "id": 10441,
    ...
    "subject": "2과목",
    "number": 42,
    "title": "제품·생산제품·생산라인 엔터티가 있을 때 제품과 생산라인을 직접 조인할 경우 발생하는 현상은?",
    "options": [
      "정상 조인 결과",
      "공집합",
      "중복 제거 결과",
    ...
    "correctIndex": 3,
    "explanation": "제품과 생산라인은 교차 엔터티인 생산제품을 거쳐 M:N 관계로 연결된다. 중간 엔터티를 건너뛰고 두 테이블을 직접 `JOIN` 하면 조인 조건이 성립할 키가 없어 모든 행이 곱해지는 카티션 곱(CROSS JOIN) 이 발생한다.",
    "_source": "authored"
  },
  {
    "id": 10442,
