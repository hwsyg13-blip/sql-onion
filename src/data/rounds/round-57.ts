...
export const ROUND_57: QuizQuestion[] = [
  ...
  },
  {
    ...
    "subject": "1과목",
    "number": 2,
    "title": "엔터티의 생성 시점에 따른 분류가 아닌 것은?",
    "options": [
      "기본 엔터티",
      "중심 엔터티",
      "사건 엔터티",
    ...
    "correctIndex": 2,
    "explanation": "생성 시점에 따른 엔터티 분류는 기본·중심·행위 세 가지이다.",
    "_source": "authored"
  },
  {
    "id": 10152,
    ...
    "options": [
      ...
      "부서코드를 별도의 테이블로 분리한다.",
      "직원 속성 값을 각 행에 하나씩만 담도록 개개 레코드로 분해한다.",
      "직원명을 관계형 배열 타입으로 저장한다."
    ],
    "correctIndex": 2,
  ...
  },
  {
    ...
    "subject": "1과목",
    "number": 4,
    "title": "다른 속성으로부터 계산이나 변형을 통해 생성되는 속성은?",
    "options": [
      "기본 속성",
      "설계 속성",
      "일반 속성",
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "주식별자는 NOT NULL 이어야 한다. NULL을 허용한다는 설명은 옳지 않다.",
    "_source": "authored"
  },
  {
    "id": 10155,
    ...
    "options": [
      ...
      "한 명의 고객이 여러 개의 계약을 가입할 경우 납부자로부터 식별자를 상속받아야 한다.",
      "고객이 계약하고 납부하면 고객 테이블과 납부자 테이블을 합칠 수 있다."
    ],
    "correctIndex": 3,
  ...
  },
  {
    ...
    "subject": "1과목",
    "number": 8,
    "title": "식별자에 대한 다음 설명 중 옳지 않은 것은?",
    "options": [
      "주식별자는 엔터티 내 인스턴스를 유일하게 구별한다.",
      "외래키(FK)는 내부 식별자이다.",
      "인조 식별자는 업무와 무관하게 시스템이 부여한 식별자이다.",
      "본질 식별자는 업무상 의미를 가지는 식별자이다."
    ],
    "correctIndex": 1,
    "explanation": "외래키는 다른 엔터티의 주식별자를 참조하여 들여온 외부 식별자이다.",
    "_source": "authored"
  },
  {
    "id": 10158,
    ...
    "options": [
      ...
      "수강 엔터티는 학생과 과목 사이의 관계 엔터티이다.",
      "과목 인스턴스 추가하려면 학생 필요하다."
    ],
    "correctIndex": 3,
  ...
  },
  {
    ...
    "references": [
      {
        "type": "sql",
        "code": "-- 각 옵션을 다음 SQL 로 평가:\nSELECT SUBSTR('abcdefgh', 7)                                    AS R1,\n       SUBSTR('abcdefgh', -2)                                   AS R2,\n       SUBSTR('abcdefgh', 8, -2)                                AS R3,\n       SUBSTR('abcdefgh', INSTR('abcdefgh', 'g'), 2)            AS R4\nFROM   DUAL;"
      }
    ]
  },
  {
    ...
    "subject": "2과목",
    "number": 13,
    "title": "COMMIT에 대한 설명 중 옳지 않은 것은?",
    "options": [
      "COMMIT 이후에는 다른 사용자가 변경된 데이터를 조회할 수 있다.",
      "COMMIT 이전에도 본인 세션에서는 SELECT로 참조할 수 있다.",
      "COMMIT 이전에 외부 사용자가 변경된 데이터를 확인할 수 있다.",
      "COMMIT 이전에 수정은 가능하다."
    ],
    "correctIndex": 2,
    "explanation": "일반적인 READ COMMITTED 고립 수준에서는 COMMIT 이전의 변경을 다른 사용자가 볼 수 없다.",
    "_source": "authored"
  },
  {
    "id": 10163,
    ...
    "subject": "2과목",
    "number": 14,
    "title": "NULL에 대한 설명 중 옳은 것은?",
    "options": [
      "NULL은 0과 같은 의미이다.",
      "NULL은 집계 함수에서 제외된다.",
      "NULL = NULL 은 TRUE 이다.",
      "바커 표기법에서는 NULL 허용 여부를 알 수 없고 IE 표기법에서는 NULL 허용 여부를 알 수 있다."
    ],
    "correctIndex": 1,
    "explanation": "SUM, AVG, MIN, MAX 등 집계 함수는 NULL 을 자동으로 제외하고 계산한다.",
    "_source": "authored"
  },
  {
    "id": 10164,
    ...
    "subject": "2과목",
    "number": 15,
    "title": "다음 중 SQL 명령어의 분류가 적절하지 않은 것은?",
    "options": [
      "DDL : TRUNCATE",
      "DML : DROP",
      "DCL : REVOKE",
  ...
  },
  {
    ...
    "options": [
      "여러 SQL 결과의 합집합으로 중복된 행은 하나의 행으로 출력한다.",
      "여러 SQL 결과의 합집합으로 중복된 행도 그대로 결과로 출력한다.",
      "여러 SQL 결과의 교집합으로 중복된 행은 하나의 행으로 출력한다.",
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 19,
    "title": "정규표현식 수량자 설명 중 옳은 것은?",
    "options": [
      "? : 대상이 0회 혹은 그 이상 반복하는지 확인한다.",
      "* : 대상이 1회 이상 반복하는지 확인한다.",
      "+ : 대상이 0회 혹은 그 이상 반복하는지 확인한다.",
      "{m,} : 대상이 m회 이상 반복하는지 확인한다."
    ],
    "correctIndex": 3,
    "explanation": "?는 0회 또는 1회, *는 0회 이상, +는 1회 이상, {m,}은 m회 이상을 의미한다. ①·②·③의 서술은 각 수량자의 정의와 일치하지 않으며 ④만 정의와 부합한다.",
    "_source": "authored"
  },
  {
    "id": 10169,
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 21,
    "title": "가장 높은 순위(최고 순위) 를 구할 때 사용이 적절하지 않은 것은?",
    "options": [
      ">= ANY",
      "RANK() OVER(ORDER BY VAL DESC) = 1",
      "MAX(VAL)",
      "FETCH FIRST 1 ROW ONLY 와 ORDER BY DESC"
    ],
    "correctIndex": 0,
    "explanation": "`>= ANY` 는 집합 내 임의의 값 이상을 의미하므로 최솟값 이상이 되어 '최고'의 의미를 표현하지 못한다. 최고를 표현하려면 `>= ALL` 또는 `= MAX(...)` 가 적절하다.",
    "_source": "authored"
  },
  {
    "id": 10171,
  ...
  },
  {
    ...
    "correctIndex": 3,
    "explanation": "그룹 단위 조건은 HAVING 으로 지정해야 하므로 ①·② 의 ORDER BY 는 조건절이 될 수 없다. \"다른 모든 부서의 평균보다 크거나 같다\" 는 조건은 서브쿼리가 돌려주는 모든 값과 비교하는 `>= ALL` 로 표현한다. ③ 의 `>= ANY` 는 어느 하나보다만 크면 되므로 최솟값 기준이 되어 의미가 다르다. 예시 데이터에서 10 번 부서 평균은 4000, 20 번 부서 평균은 3500 이므로 ④ 는 10 번 부서만 남겨 최대 급여 5000 을 반환한다.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
      ...
      {
        "type": "text",
        "content": "부서별 평균 급여가 가장 높은 부서의 최대 급여를 조회한다."
      },
      {
        "type": "sql",
        "code": "SELECT MAX(SAL)\nFROM   EMP\nGROUP BY DEPTNO\n(  ?  );"
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 24,
    "title": "윈도우 절에서 행 단위(Row-based)로 윈도우 프레임을 지정할 때 사용하는 키워드는?",
    "options": [
      "ROWS",
      "RANGE",
      "GROUPS",
    ...
    "correctIndex": 0,
    "explanation": "ROWS 는 행 개수 기반, RANGE 는 논리 값 기반으로 프레임을 정의한다.",
    "_source": "authored"
  },
  {
    "id": 10174,
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 26,
    "title": "고유키(UNIQUE) 제약조건에 대한 설명 중 옳지 않은 것은?",
    "options": [
      "고유키 컬럼에는 NULL 값이 여러 개 올 수 없다.",
      "기본키는 고유키와 NOT NULL 제약조건이 합쳐진 상태이다.",
      "고유키는 한 테이블에 여러 개 정의할 수 있다.",
      "고유키 컬럼에는 기본적으로 인덱스가 자동 생성된다."
    ],
    "correctIndex": 0,
    "explanation": "고유키 컬럼은 NULL 을 허용하며 여러 개의 NULL 값을 저장할 수 있다.",
    "_source": "authored"
  },
  {
    "id": 10176,
    ...
    "correctIndex": 2,
    "explanation": "패턴 'u[a-z]*day$' 는 소문자 u 가 나온 뒤 소문자가 0 개 이상 이어지고 문자열이 day 로 끝나는 값을 찾는다. Tuesday(T-u-esday), Saturday(Sat-u-rday), Sunday(S-u-nday) 는 모두 u 뒤에 day 로 끝나는 형태라 조회된다. 반면 Friday 에는 u 가 없어 조회되지 않으므로 정답은 ③ 이다. (Monday·Wednesday 도 같은 이유로 조회되지 않는다.)",
    "_source": "authored",
    "references": [
      {
        "type": "table",
      ...
      {
        "type": "sql",
        "code": "SELECT 요일\nFROM   요일테이블\nWHERE  REGEXP_LIKE(요일, 'u[a-z]*day$');"
      }
    ]
  },
  {
    ...
    "options": [
      "디폴트를 설정하면 전체 성능이 떨어진다.",
      "데이터가 들어 있는 NUMBER 형 컬럼의 크기는 늘릴 수는 있어도 줄일 수는 없다.",
      "NULL 이 없을 때만 NOT NULL 제약조건을 설정할 수 있다.",
      "PRIMARY KEY 제약을 추가하려면 대상 컬럼에 중복 값이 없어야 한다."
    ],
    "correctIndex": 0,
    "explanation": "DEFAULT 는 값을 입력하지 않았을 때 채워 넣을 기본값을 지정하는 것으로 전체 성능과 직접 관련이 없으므로 ①이 옳지 않다. ② 기존 데이터가 훼손될 수 있으므로 데이터가 들어 있는 컬럼의 크기는 줄일 수 없다(컬럼이 비어 있으면 축소 가능). ③ NOT NULL 은 기존 데이터에 NULL 이 없어야 추가할 수 있고, ④ PRIMARY KEY 는 중복 값과 NULL 이 없어야 추가할 수 있다.",
    "_source": "authored"
  },
  {
    "id": 10178,
    ...
    "subject": "2과목",
    "number": 29,
    "title": "동일 값에 동일 순위를 부여하되 다음 순위를 건너뛰지 않는 순위 함수는?",
    "options": [
      "DENSE_RANK",
      "RANK",
      "ROW_NUMBER",
    ...
    "correctIndex": 0,
    "explanation": "RANK 는 건너뛰고, DENSE_RANK 는 건너뛰지 않는다. PERFECT_RANK 는 존재하지 않는 함수이다.",
    "_source": "authored"
  },
  {
    "id": 10179,
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 31,
    "title": "중복을 제거하고 개수를 세는 SQL 로 가장 적절한 것은?",
    "options": [
      "COUNT(DISTINCT COL)",
      "COUNT(*)",
      "COUNT(ALL COL)",
    ...
    "correctIndex": 0,
    "explanation": "COUNT(DISTINCT COL)은 COL 값의 중복을 제외한 고유 건수를 반환한다.",
    "_source": "authored"
  },
  {
    "id": 10181,
    ...
    "subject": "2과목",
    "number": 32,
    "title": "아래 두 테이블 TAB1, TAB2 로 LEFT·RIGHT·FULL OUTER·INNER JOIN 을 각각 수행했을 때 결과 행 수의 총 합은?",
    "options": [
      "14",
      "15",
      "16",
    ...
    "correctIndex": 2,
    "explanation": "공통 행은 G 하나. INNER 1건, LEFT(TAB1 기준) 4건, RIGHT(TAB2 기준) 4건, FULL OUTER 7건(매칭 1 + 미매칭 3 + 3). 합계 = 1 + 4 + 4 + 7 = 16.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 35,
    "title": "동일한 이름의 컬럼을 기준으로 자동 조인을 수행하는 JOIN 방식은?",
    "options": [
      "INNER JOIN",
      "LEFT OUTER JOIN",
      "NATURAL JOIN",
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 36,
    "title": "아래 네 개의 SQL ㄱ·ㄴ·ㄷ·ㄹ 중 오류가 발생하는 개수는?",
    "options": [
      "2개",
      "1개",
      "3개",
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 40,
    "title": "아래 사원 테이블에서 2 등급(급여 1,200 ~ 1,400) 에 해당하는 사원의 수는?",
    "options": [
      "1개",
      "2개",
      "3개",
    ...
    "correctIndex": 2,
    "explanation": "BETWEEN 1200 AND 1400 (양 끝 포함) 조건을 만족하는 행은 B(1,200), C(1,300), D(1,400) 3 명. A(1,100) 와 E(1,500) 은 범위 밖.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
      ...
      {
        "type": "sql",
        "code": "SELECT COUNT(*)\nFROM   사원\nWHERE  급여 BETWEEN 1200 AND 1400;"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 43,
    "title": "아래 MONTHLY 테이블에 대한 SQL 결과에 포함되는 월로 옳은 것은?",
    "options": [
      "2022년 12월과 2023년 2월",
      "2022년 11월과 2023년 4월",
      "2023년 3월과 2023년 4월",
      "2022년 11월, 12월 / 2023년 3월, 5월"
    ],
    "correctIndex": 3,
    "explanation": "`BETWEEN '2022-11' AND '2023-05'` 로 7 개월(2022-11, 12, 2023-01, 02, 03, 04, 05) 이 후보가 된다. `EXTRACT(MONTH ...) NOT IN (1, 2, 4)` 로 1·2·4 월을 제거하면 남는 건 2022-11, 2022-12, 2023-03, 2023-05 의 4 개월.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "결과 표를 보면 (DEPT=10, JOB=CLERK) 같은 세부 집계, (DEPT=10, JOB=NULL) 부서 소계, (NULL, NULL) 전체 총계가 나타난다. 이는 ROLLUP(DEPT, JOB) 이 만드는 (DEPT, JOB) → (DEPT) → () 패턴과 정확히 일치. CUBE 는 추가로 (JOB) 단독 소계까지 만들고, GROUPING SETS 는 명시 그룹만, GROUP BY 는 세부 집계만 만든다.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 46,
    "title": "아래 EMP 테이블에 대한 SQL 의 괄호에 들어갈 수 없는 컬럼은?",
    "options": [
      "EMPNO",
      "JOB",
      "DEPT",
    ...
    "correctIndex": 0,
    "explanation": "`GROUP BY JOB, DEPT` 가 명시된 SQL 에서 SELECT 절에는 GROUP BY 에 포함된 컬럼(JOB, DEPT) 또는 집계 함수만 올 수 있다. ① EMPNO 는 GROUP BY 에 없는 일반 컬럼이라 집계 함수 없이 그대로 쓰면 ORA-00979 오류 발생. ②③ 은 그룹 컬럼이라 OK, ④ NULL 은 상수라 OK.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "이름이 같은 행 중에서 가장 작은 ID 만 남기려면, 우선 NAME 으로 그룹화한 뒤 그룹별 MIN(ID) 를 구해 'NOT IN' 으로 그 외 행을 모두 삭제해야 한다. 따라서 첫 번째 빈칸은 MIN(ID), 두 번째 빈칸은 NAME 이며 정답은 ①. 예를 들어 아래 데이터에서 '홍길동' 그룹은 MIN(ID)=1 만 남고 (3,4) 가 삭제, '김철수' 그룹은 MIN(ID)=2 만 남고 5 가 삭제된다.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "options": [
      "WHERE 절을 `WHERE 회원ID NOT IN (SELECT 회원ID FROM 탈퇴)` 로 바꿔도 결과가 동일하다.",
      "WHERE 절을 `WHERE EXISTS (SELECT 1 FROM 탈퇴 T WHERE T.회원ID = M.회원ID)` 로 바꿔도 결과가 동일하다.",
      "WHERE 절을 `WHERE 회원ID NOT IN T.회원ID` 로 바꿔도 결과가 동일하다.",
      "서브쿼리의 `SELECT X` 를 `SELECT NULL` 로 바꿔도 결과가 동일하다."
    ],
    "correctIndex": 3,
    "explanation": "NOT EXISTS 는 서브쿼리가 행을 반환하는지 여부만 판정하므로 서브쿼리의 SELECT 절에 컬럼·상수·NULL 중 무엇을 써도 결과가 같다. 따라서 ④ 가 옳다. ① NOT IN 은 비교 대상에 NULL 이 하나라도 있으면 어떤 행도 참이 되지 못하는데, 탈퇴 테이블에 NULL 이 있으므로 결과가 공집합이 되어 달라진다. ② EXISTS 는 NOT EXISTS 와 반대로 탈퇴 이력이 있는 회원만 남긴다. ③ 은 부속 질의 없이 컬럼을 비교하는 잘못된 구문이다.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 49,
    "title": "아래 EMP 테이블에 대한 SQL 의 출력 레이블 가공으로 가장 적절한 CASE-GROUPING 조합은?",
    "options": [
