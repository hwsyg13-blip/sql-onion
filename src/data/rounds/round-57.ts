...
export const ROUND_57: QuizQuestion[] = [
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation": "①·②·④ 는 모두 'gh' 를 반환한다. ③은 길이에 음수가 지정되어 Oracle에서는 NULL을 반환한다.",
    "_source": "authored"
  },
  {
    "id": 10162,
  ...
  },
  {
    ...
    "subject": "2과목",
    "number": 22,
    "title": "부서 ID가 100인 부서의 최상위부터 최하위까지 계층 경로를 출력하는 조건으로 옳은 것은?",
    "options": [
      "서브쿼리 사용, PRIOR 상위 = 부서",
      "서브쿼리 사용, 부서 = PRIOR 상위",
      "PRIOR 상위 = 부서",
    ...
    "correctIndex": 3,
    "explanation": "PRIOR 절의 좌측이 현재 행, 우측이 부모 행이 되도록 'PRIOR 상위' 를 부모에 두어야 부서 계층을 위에서 아래로 탐색할 수 있다.",
    "_source": "authored"
  },
  {
    "id": 10172,
