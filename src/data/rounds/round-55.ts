...
export const ROUND_55: QuizQuestion[] = [
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "순방향(부모→자식) 전개에서는 현재 행의 사원번호(PRIOR 사원번호)가 다음 행의 관리자번호와 일치해야 하므로 'PRIOR 사원번호 = 관리자번호'가 된다.",
    "_source": "authored",
    "references": [
      {
        "type": "sql",
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "'홍길동'을 A, 자식을 B(B.MGR=A.EMPNO), 자식의 자식을 C(C.MGR=B.EMPNO)로 두고 EMP 테이블을 세 번 셀프 조인하여 C를 조회한다.",
    "_source": "authored"
  },
  {
    "id": 10279,
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "그룹 함수 결과를 필터링할 때는 HAVING을 사용하며, 3회 이상 주문 조건은 COUNT(구매번호) >= 3으로 표현한다. WHERE 절에는 집계 함수를 직접 사용할 수 없다.",
    "_source": "authored",
    "references": [
      {
        "type": "sql",
