...
export const ROUND_54: QuizQuestion[] = [
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation": "정규식 `^[0-9]{3}-[0-9]{3,4}-[0-9]{4}$` 는 앞자리 3 자리, 가운데 3~4 자리, 뒷자리 4 자리를 요구한다. 02-1234-5678 은 서울 지역번호라 앞자리가 2 자리뿐이어서 조건을 만족하지 못해 조회되지 않는다. 나머지 세 번호는 앞자리가 3 자리이고 가운데가 3 자리든 4 자리든 허용 범위 안에 들어간다.",
    "_source": "authored",
    "references": [
      {
        "type": "table",
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation": "UNIQUE 는 값의 중복만 막을 뿐 NULL 은 허용하므로 ③ 이 적절하지 않다. NULL 까지 막으려면 NOT NULL 제약을 따로 지정해야 한다. 반면 PRIMARY KEY 는 유일성과 NOT NULL 을 함께 강제한다.",
    "_source": "authored"
  },
  {
    "id": 10325,
