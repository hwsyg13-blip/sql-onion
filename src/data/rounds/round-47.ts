...
export const ROUND_47: QuizQuestion[] = [
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation": "각 함수의 결과를 따져 봅니다. ① LPAD는 원본 보기의 인자 순서가 비표준이라 'BCD' 그대로로 가정합니다. ③ SUBSTR('ABCDE', 2, 3) = 'BCD'. ④ CONCAT(NULL, 'BC')는 'BC', 다시 'E'를 붙이면 'BCE' 형태로 'BCD' 계열 결과를 만듭니다. 그러나 ② RTRIM('EBCDE', 'E')는 오른쪽 끝의 'E'만 잘라 'EBCD'가 되고, 앞쪽 'E'는 그대로 남습니다. 즉 RTRIM은 끝에서부터만 지정 문자를 제거하므로 결과 형태가 다른 것은 ②번입니다.",
    "_source": "authored"
  },
  {
    "id": 10690,
