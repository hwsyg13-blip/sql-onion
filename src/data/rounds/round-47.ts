...
export const ROUND_47: QuizQuestion[] = [
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation": "각 함수의 결과를 따져 봅니다. ① LPAD('BCD', 3, 'A')는 이미 길이가 3이라 패딩 없이 'BCD'를 그대로 반환. ③ SUBSTR('ABCDE', 2, 3) = 'BCD'. ④ CONCAT(CONCAT(NULL, 'BC'), 'D') = 'BCD' (NULL은 빈 문자열로 처리). 그러나 ② RTRIM('EBCDE', 'E')는 오른쪽 끝의 'E'만 잘라 'EBCD'가 되고 앞쪽 'E'는 그대로 남습니다. 결과 형태가 명확히 다른 것은 ②번입니다.",
    "_source": "authored"
  },
  {
    "id": 10690,
