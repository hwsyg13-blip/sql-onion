...
export const ROUND_58: QuizQuestion[] = [
  {
    ...
    "correctIndex": 1,
    "explanation": "키(기본) 엔터티는 다른 엔터티로부터 주식별자를 상속받지 않고 독립적으로 생성되는 엔터티이다. 회사·부서·사원은 각각 고유한 주식별자를 가지고 부모의 키를 일반 속성(FK)으로만 참조하는 비식별자 관계이므로 모두 키 엔터티이다. 반면 프로젝트는 사원과 식별자 관계로 연결되어 사원번호를 자신의 주식별자에 포함하므로 키 엔터티에 해당하지 않는다.",
    "_source": "authored",
    "references": [
      {
        "type": "erd",
        "caption": "회사·부서·사원은 비식별자 관계, 사원-프로젝트는 식별자 관계",
        "mermaid": "erDiagram\n    회사 ||--o{ 부서 : \"보유\"\n    부서 ||--o{ 사원 : \"소속\"\n    사원 ||--o{ 프로젝트 : \"수행\"\n    회사 {\n        string 회사번호 PK\n    }\n    부서 {\n        string 부서번호 PK\n        string 회사번호 FK\n    }\n    사원 {\n        string 사원번호 PK\n        string 부서번호 FK\n    }\n    프로젝트 {\n        string 사원번호 PK\n        string 프로젝트번호 PK\n    }"
      }
    ]
  },
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation": "ERD 에서 컴퓨터 측 참여는 필수 1 이므로 모든 컴퓨터는 반드시 하나의 마더보드를 가진다. 따라서 마더보드를 사용하지 않을 수도 있다는 ② 가 옳지 않다. ① 마더보드 하나는 최대 한 대의 컴퓨터에만 장착되므로 옳고, ③ 마더보드 측 참여는 선택(0..1) 이라 아직 장착되지 않은 마더보드도 존재할 수 있어 옳으며, ④ 마더보드의 주식별자는 마더보드번호로 컴퓨터번호와 별개이므로 옳다.",
    "_source": "authored",
    "references": [
      {
        "type": "erd",
        "caption": "컴퓨터-마더보드 ERD (컴퓨터는 마더보드를 반드시 가지며, 마더보드는 별도 주식별자를 가진다)",
        "mermaid": "erDiagram\n    마더보드 ||--o| 컴퓨터 : \"장착\"\n    컴퓨터 {\n        string 컴퓨터번호 PK\n        string 모델명\n    }\n    마더보드 {\n        string 마더보드번호 PK\n        string 컴퓨터번호 FK\n    }"
      }
    ]
  },
